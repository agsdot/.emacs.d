...
(egb-use-package2 restart-emacs)
...
;;(egb-use-package2 ethan-wspace)

;;(egb-use-package2 apropospriate-theme)
;;(use-package apropospriate-theme
;;  :init
;;  (progn
;;    (load-theme 'apropospriate-dark t)))

;;(egb-use-package2 atom-dark-theme)
...
;;(egb-use-package2 zenburn-theme)
;;(use-package zenburn-theme
;;  :init
;;  (progn
;;    (load-theme 'zenburn t)))

(egb-use-package2 seoul256-theme
  :init
  (progn
    (setq seoul256-background 235)
    (load-theme 'seoul256 t)))

;;(egb-use-package2 ample-theme)
...
;;(egb-use-package2 monokai-theme)
...
(egb-use-package2 smex)

;;(el-get-bundle swiper
;;  :features ivy)
(egb-use-package2 swiper
  :features ivy)
(use-package ivy
...
(egb-use-package2 counsel-projectile
  :defer t
  :config
  (progn
    (counsel-projectile-on)))

(egb-use-package2 dashboard
  :config
  (progn
...
(egb-use-package2 ace-jump-mode
  :config
  (progn
...
(egb-use-package2 git-gutter
  :diminish git-gutter-mode
  :config
  (progn
    (global-git-gutter-mode 1)))

(egb-use-package2 git-timemachine)

(egb-use-package2 editorconfig
  :config
  (progn
    (editorconfig-mode 1)))

(egb-use-package2 php-mode
  :config
  (progn
...
(when (executable-find "js-beautify")
  (egb-use-package2 web-beautify))

(egb-use-package2 js2-mode
  :config
  (progn
...
(egb-use-package2 rainbow-mode
  :init
  (dolist (hook '(css-mode-hook html-mode-hook))
    (add-hook hook 'rainbow-mode)))

(egb-use-package2 groovy-mode
  :config
  (progn
...
(egb-use-package2 go-mode
  :config
  (progn
    (autoload 'go-mode "go-mode" "Major mode for editing Go code." t)
    (add-to-list 'auto-mode-alist '("\\.go?\\'" . go-mode))))

(egb-use-package2 lua-mode
  :config
  (progn
    (add-to-list 'auto-mode-alist '("\\.lua?\\'" . lua-mode))))

(egb-use-package2 vimrc-mode
  :config
  (progn
    (add-to-list 'auto-mode-alist '(".vim\\(rc\\)?$" . vimrc-mode))))

(egb-use-package2 drag-stuff
  :config
  (progn
...
(egb-use-package2 linum-relative
  :config
  (progn
...
#+BEGIN_SRC emacs-lisp
(egb-use-package2 goto-chg)
;; evil mode setup ;;
(setq evil-want-C-w-in-emacs-state t)
(setq evil-default-cursor t)
(egb-use-package2 evil
  :config
  (progn
    (evil-mode 1)
    ...
    (egb-use-package2 evil-escape
      :config
      (progn
        (evil-escape-mode)
        (setq-default evil-escape-key-sequence "kj")))

    (egb-use-package2 evil-leader
      :config
      (progn
    ...
    (egb-use-package2 evil-nerd-commenter
      :commands (evilnc-comment-or-uncomment-lines)
      :config
      (progn
        (evilnc-default-hotkeys)))

    (egb-use-package2 evil-matchit
      :config
      (progn
        (global-evil-matchit-mode 1)))

    (egb-use-package2 evil-surround
      :config
      (progn
        (global-evil-surround-mode 1)))

    (egb-use-package2 evil-visualstar
      :config
      (progn
        (global-evil-visualstar-mode)))

    (egb-use-package2 magit
      :config
      (progn

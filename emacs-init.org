...
(defcustom dotemacs-backup-elpa-directory (concat user-emacs-directory ".backup-elpa/")
  "The storage location for elpa mirror files (e.g. *.el and *.tar files).")
...
;; Go to the github page for more instructions and configuration options

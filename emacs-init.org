...
(use-package elpa-mirror :quelpa
  :config
  (progn
...
;; retain smex for the sort by most recent / frequently used commands
...
;;(use-package validate :quelpa)
(use-package validate :quelpa (validate :stable nil :fetcher github :repo "Malabarba/validate.el"))
...
(use-package dashboard :quelpa
  :ensure nil ;; git clone manually in ~/.emacs.d/custom/emacs-dashboard
  :config
  (progn
...
(use-package git-timemachine :quelpa)
...
(when (executable-find "js-beautify")
  (use-package web-beautify :quelpa))
...
(use-package vimrc-mode :quelpa
  :config
  (progn
    (add-to-list 'auto-mode-alist '(".vim\\(rc\\)?$" . vimrc-mode))))

(use-package drag-stuff :quelpa
  :config
  (progn
...
(use-package linum-relative :quelpa
  :config
  (progn
...
;;(quelpa '(goto-chg :fetcher wiki :files ("goto-chg.el")))
;;(quelpa '(goto-chg :url "https://www.emacswiki.org/emacs/download/goto-chg.el" :fetcher url))
(use-package goto-chg :quelpa (goto-chg :stable nil :fetcher github :repo "benaiah/goto-chg"))
...
(use-package evil :quelpa
  ...
  (progn
    ...
    ;; then can just press r or p for recent or projects
    ...
    (use-package key-chord
      :quelpa (key-chord :stable nil :fetcher github :repo "emacsmirror/key-chord")
      :config
      (progn
        (key-chord-mode 1)
	(key-chord-define evil-insert-state-map "kj" 'evil-normal-state)))

    (use-package evil-leader :quelpa
      :config
      (progn
    ...
    (use-package evil-nerd-commenter :quelpa
    ...
    (use-package evil-visualstar :quelpa
      :config
      (progn
        (global-evil-visualstar-mode)))

     ;; (use-package evil-tabs :quelpa
     ;;   :config
     ;;   (progn
     ;;     (global-evil-tabs-mode t)))

     (use-package evil-quickscope :quelpa
       :config
       (progn
         (global-evil-quickscope-mode 1)))

    (use-package evil-numbers :quelpa
      :config
      (progn
...
;; https://github.com/quelpa/quelpa/issues/108
...
;; annoying alerts about bytecompile
;;https://stackoverflow.com/questions/23749267/how-do-i-disable-warnings-at-initialization-in-emacs
(byte-recompile-directory (expand-file-name "~/.emacs.d/quelpa/build") 0)

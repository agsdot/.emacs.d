...
(egb-use-package base16
  :disabled
  :features base16-theme
  :pkgname base16-theme
  :demand t
  :config
...
(defun emacs-init-save-hook()
  (when (eq major-mode 'org-mode)
    ...
    (funcall (lambda ()
      ...
      (let ((src "~/.emacs.d/config/emacs-init.org")
            (dst "~/.emacs.d/config/emacs-init.el"))
...
(add-hook 'after-save-hook 'emacs-init-save-hook)

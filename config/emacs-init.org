...
(defun kill-other-buffers ()
  ...
  (custom/kill-buffers "^\\*Treemacs") ;; kill Treemacs buffers
)
...
(use-package general
  ...
  (progn
    ...
    (general-define-key
      ...
      "oo"     'treemacs-visit-node-default-action
...
(use-package evil-integrations
  :recipe (evil-integrations :type git :host github :repo "jojojames/evil-integrations"))
(use-package evil
  :demand t
  :config
  (progn
    ...
    ;; ex commands make sure that treemacs is exited from
